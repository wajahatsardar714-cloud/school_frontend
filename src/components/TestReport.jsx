            ...
            <div className="report-modal-content">
              ...
              <div className="report-viewer">
                {selectedReport.file_type?.includes('pdf') ? (
                  <iframe 
                    src={`${import.meta.env.VITE_API_BASE_URL || 'http://localhost:5000'}/${selectedReport.file_path}`}
              ...
              <div className="report-modal-actions">
                <a 
                  href={`${import.meta.env.VITE_API_BASE_URL || 'http://localhost:5000'}/${selectedReport.file_path}`}
                  target="_blank"
