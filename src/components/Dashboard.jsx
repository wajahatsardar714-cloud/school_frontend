  ...
  return (
    <div className="page-content dashboard-enhanced">
      ...
      <div className="dashboard-actions">
        ...
        {isAdmin() && (
          <Link to="/faculty/salary-vouchers" className="dashboard-btn gradient-purple">
            <div className="btn-icon-wrapper">
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <Link to={`/fees/payments?date=${new Date().toISOString().split('T')[0]}`} className="dashboard-btn gradient-indigo">
          <div className="btn-icon-wrapper">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="btn-content">
            <span className="btn-title">Today's Fee Collection</span>
            <span className="btn-subtitle">View today's fee payments</span>
          </div>
        </Link>

        <Link to="/fees/defaulters" className="dashboard-btn gradient-rose">
          <div className="btn-icon-wrapper">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="btn-content">
            <span className="btn-title">Fee Defaulters</span>
            <span className="btn-subtitle">Students with pending fees</span>
          </div>
        </Link>

        <Link to={`/expenses?date=${new Date().toISOString().split('T')[0]}`} className="dashboard-btn gradient-yellow">
          <div className="btn-icon-wrapper">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="btn-content">
            <span className="btn-title">Today's Expenses</span>
            <span className="btn-subtitle">View today's expenditures</span>
          </div>
        </Link>
      </div>
    </div>
