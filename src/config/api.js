export const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || 'https://school-backend-onou.onrender.com'
...
export const API_ENDPOINTS = {
  ...
  STUDENT_YEARLY_PACKAGE: (id) => `/api/students/${id}/yearly-package`,
